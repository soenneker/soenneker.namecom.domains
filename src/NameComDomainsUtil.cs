...
public class NameComDomainsUtil: INameComDomainsUtil
{
    ...
    public async ValueTask<ListDomainsResponse?> ListDomains(ListDomainsRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> GetDomain(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<CreateDomainResponse?> CreateDomain(CreateDomainRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> EnableWhoisPrivacy(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> DisableWhoisPrivacy(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> EnableAutorenew(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> DisableAutorenew(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<RenewDomainResponse?> RenewDomain(string domainName, RenewDomainRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<GetDomainPricingResponse?> GetPricingForDomain(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<GetAuthCodeResponse?> GetAuthCodeForDomain(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<PurchasePrivacyResponse?> PurchasePrivacy(string domainName, PurchasePrivacyRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> SetNameservers(string domainName, SetNameserversRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> SetContacts(string domainName, SetContactsRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> LockDomain(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<NameComDomain?> UnlockDomain(string domainName, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<CheckAvailabilityResponse?> CheckAvailability(CheckAvailabilityRequest request, CancellationToken cancellationToken = default)
    {
    ...
    public async ValueTask<SearchResponse?> Search(SearchRequest request, CancellationToken cancellationToken = default)
    {
